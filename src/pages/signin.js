...
const Signin = {
	...
	render() {
		return /*html*/`
		<form id="formSignin" >
			<div class=" bg-gray-100 flex-col justify-center flex gap-4 items-start mx-4 py-12">
									...
									<div class="flex flex-col pt-4">
										<div class="flex relative ">
											...
											class=" flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
												...
												/>
												{formik.errors.email && (
													<p class="red-500"> {formik.errors.email} </p>
												    )}
										</div>
									</div>
										...
										<div class="flex relative ">
											...
											<input type="password" id="password"
												...
												{formik.errors.password && (
													<p class="red"> {formik.errors.password} </p>
												    )}
										</div>
									</div>
									<button type="submit"
